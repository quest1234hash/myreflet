        ...
        document.querySelectorAll(".use-keyboard-input").forEach(element => {
            element.addEventListener("focus", () => {
                this.open(element.value, currentValue => {
                   ...
                   // var el_index=element.attr("tabindex");

                   var el_index=element.getAttribute("tabindex");
                   var next_index=parseInt(el_index)+1;

                   

                   // alert('length'+currentValue.length);
