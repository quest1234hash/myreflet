      ...
      async function wait_hash(){
               if (self_attested_hash) {
                  ...
                  await request(`https://ipfs.io/ipfs/${fun_hash}`, async function (error, response, body) {
                    ...
                    // await Jimp.create(720,520,'#ffffff',async function(err, nova_new) {
                        await Jimp.create(image.bitmap.width ,((image.bitmap.height)+((image.bitmap.width/4)+30)),'green',async function(err, nova_new) {
                       ...
                       //    .then(async (font) => {
                           ...
                           var c;
                            ...
                            nova_new.print(font,5,image.bitmap.height,"nova_new")
