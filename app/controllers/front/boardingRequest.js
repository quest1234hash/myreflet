...
exports.penRequestViewClientInfo=async (req,res,next)=>{
  ...
  let sub_verifer_reflect_id  = req.query.sub_verifier_reflect_id
...
await db.query("SELECT * FROM tbl_wallet_reflectid_rels INNER JOIN tbl_user_registrations ON tbl_user_registrations.reg_user_id=tbl_wallet_reflectid_rels.reg_user_id LEFT JOIN tbl_countries ON tbl_wallet_reflectid_rels.companyCountry=tbl_countries.country_id WHERE tbl_wallet_reflectid_rels.reg_user_id="+user_id,{ type:db.QueryTypes.SELECT}).then(async contact_n_country =>{
...
exports.request_update_perm = async (req,res,next) =>{
 ...
 let video_proof =req.body.video_proof
 let sign = req.body.sign
 let self_attest = req.body.self_certify
  ...
  if(complete){
    complete = 'yes';
    permission_msg = permission_msg+',complete';
  ...
  if(sign){
    sign = 'yes';
    permission_msg = permission_msg+',sign';
  ...
  if(video_proof){
    video_proof = 'yes';
    permission_msg = permission_msg+',video_proof';
  ...
  if(self_attest){
    self_attest = 'yes';
    permission_msg = permission_msg+',self_attest';
...
//**outer loop start
  for(var i=0;i<user_doc_id_array.length;i++){
    ...
    await db.query('SELECT * FROM tbl_request_documents WHERE request_id="'+request_id+'" AND user_doc_id='+user_doc_id_array[i],{type:db.QueryTypes.SELECT}).then(async final_doc =>{
      ...
      await updatePrmRequestModel.create({request_id:request_id,user_doc_id:user_doc_id_array[i],version_count:version_count,view_status:view_status,download_status:download_status,certify_status:certify_status,video_proof,self_attest,complete,sign}).then(async success_result =>{
...
exports.invite_client_by_refletid = async (req,res,next) =>{
  ...
  exports.searchAcceptRequestOnBoarding= async(req,res,next )=>{
    ...
    db.query('SELECT * ,tbl_wallet_reflectid_rels.reflect_code as v_r_code ,tbl_wallet_reflectid_rels.reflectid_by as v_reflectid_by,tbl_wallet_reflectid_rels.rep_username as v_rep_username,tbl_wallet_reflectid_rels.entity_company_name as v_entity_company_name ,tbl_client_verification_requests.createdAt as request_createdAt FROM `tbl_client_verification_requests` INNER JOIN tbl_wallet_reflectid_rels ON tbl_wallet_reflectid_rels.reflect_id=tbl_client_verification_requests.verifer_my_reflect_id INNER JOIN tbl_wallet_reflectid_rels as c ON c.reflect_id=tbl_client_verification_requests.reflect_id INNER JOIN tbl_user_registrations ON tbl_user_registrations.reg_user_id=tbl_client_verification_requests.client_id  WHERE tbl_client_verification_requests.verifier_id="'+userId+'" AND tbl_client_verification_requests.deleted="0" AND tbl_client_verification_requests.request_status="accept" AND tbl_client_verification_requests.removed_request="no" and  (tbl_wallet_reflectid_rels.rep_username LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.wallet_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.entity_company_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.reflect_code LIKE "%'+query+'%" or tbl_user_registrations.email LIKE "%'+query+'%" or tbl_client_verification_requests.request_code LIKE "%'+query+'%") order by request_id desc',{type:db.QueryTypes.SELECT}).then(RequsetOnBoardingACCEPT=>{

              
              db.query('SELECT *,tbl_wallet_reflectid_rels.reflect_code as v_r_code ,tbl_wallet_reflectid_rels.reflectid_by as v_reflectid_by,tbl_wallet_reflectid_rels.rep_username as v_rep_username,tbl_wallet_reflectid_rels.entity_company_name as v_entity_company_name ,tbl_client_verification_requests.createdAt as request_createdAt FROM `tbl_sub_verifier_clients` INNER JOIN tbl_client_verification_requests ON tbl_client_verification_requests.request_id=tbl_sub_verifier_clients.client_request_id INNER JOIN tbl_wallet_reflectid_rels ON tbl_wallet_reflectid_rels.reflect_id=tbl_client_verification_requests.verifer_my_reflect_id INNER JOIN tbl_wallet_reflectid_rels as c ON c.reflect_id=tbl_client_verification_requests.reflect_id INNER JOIN tbl_user_registrations ON tbl_user_registrations.reg_user_id=tbl_client_verification_requests.client_id WHERE tbl_sub_verifier_clients.sub_verifier_reg_id="'+userId+'" AND tbl_sub_verifier_clients.deleted="0" AND tbl_sub_verifier_clients.sub_client_status="active" AND tbl_client_verification_requests.deleted="0" AND tbl_client_verification_requests.removed_request="no" and  ( tbl_wallet_reflectid_rels.rep_username LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.wallet_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.entity_company_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.reflect_code LIKE "%'+query+'%" or tbl_user_registrations.email LIKE "%'+query+'%" or tbl_client_verification_requests.request_code LIKE "%'+query+'%") order by request_id desc',{type:db.QueryTypes.SELECT}).then(subverifierAssignClient=>{
                            ...
                            if(subverifierAssignClient[i].request_status=="accept"){
                              subverifierAssignClient[i].allocated = {sub_ver_my_reflect_id:subverifierAssignClient[i].sub_verifier_reflect_id}
                                  ...
                                  RequsetOnBoardingACCEPT.push(subverifierAssignClient[i])
                                         ...
                                         res.render('front/user-on-boarding-request/accept_search_boarding_ajax',{
                                                                                   RequsetOnBoardingACCEPT,
...
exports.searchPendingRequestOnBoarding= async(req,res,next )=>{
    ...
    err_msg = req.flash('err_msg');
        ...
        db.query('SELECT * ,tbl_wallet_reflectid_rels.reflect_code as v_r_code ,tbl_wallet_reflectid_rels.reflectid_by as v_reflectid_by,tbl_wallet_reflectid_rels.rep_username as v_rep_username,tbl_wallet_reflectid_rels.entity_company_name as v_entity_company_name, tbl_client_verification_requests.createdAt as request_createdAt FROM `tbl_client_verification_requests` INNER JOIN tbl_wallet_reflectid_rels ON tbl_wallet_reflectid_rels.reflect_id=tbl_client_verification_requests.verifer_my_reflect_id INNER JOIN tbl_wallet_reflectid_rels as c ON c.reflect_id=tbl_client_verification_requests.reflect_id INNER JOIN tbl_user_registrations ON tbl_user_registrations.reg_user_id=tbl_client_verification_requests.client_id  WHERE tbl_client_verification_requests.verifier_id="'+userId+'" AND tbl_client_verification_requests.deleted="0" AND tbl_client_verification_requests.request_status="pending" AND tbl_client_verification_requests.removed_request="no" and  ( tbl_wallet_reflectid_rels.rep_username LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.wallet_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.entity_company_name LIKE "%'+query+'%" or tbl_wallet_reflectid_rels.reflect_code LIKE "%'+query+'%" or tbl_user_registrations.email LIKE "%'+query+'%" or tbl_client_verification_requests.request_code LIKE "%'+query+'%" or tbl_client_verification_requests.request_code LIKE "%'+query+'%") order by request_id desc',{type:db.QueryTypes.SELECT}).then(RequsetOnBoardingPending=>{
                     ...
                     for (let i = 0; i < subverifierAssignClient.length; i++) {
                            ...
                            if(subverifierAssignClient[i].request_status=="pending"){
                                  RequsetOnBoardingPending.push(subverifierAssignClient[i]) 
                                         ...
                                         res.render('front/user-on-boarding-request/pending_search_boarding_ajax',{
                                                                                   RequsetOnBoardingPending,
