...
<div id="mySidenav" class="sidenav">
   ...
   <ul class="aside-wrapper">
       <li>
        <a href="../dashboard-verifier/dashboard.php">
       ...
       <li>
        ...
        <ul class="cus-sub-menu">
            <li><a href="../my-reflet-id-verifier/manage-categeory.php" class="active">Manage Category</a></li>
        ...
        <ul class="cus-sub-menu">
            <li><a href="../sub-verifier/manage-sub-verifier.php" class="active">Manage Sub-Verifiers</a></li>
