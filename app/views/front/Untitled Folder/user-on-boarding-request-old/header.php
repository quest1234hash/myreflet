...
<div id="warpper" class="side-menu mobile-menu">
<!-- Header html -->
...
<div id="mySidenav" class="sidenav">
   ...
   <ul>
       <li><a href="../dashboard/dashboard.php" class="active">
       ...
       <li>
        <a href="../my-reflet-id/my-reflet-id-code.php">
        ...
        <li>
        <a href="../address-book/address-book.php" >
           <img src="../assets/images/icons/home-assets/addressbook-purple.png" class="white-img" alt="Wallet">
           <img src="../assets/images/icons/home-assets/addressbook.png" class="black-icon" alt="Wallet">
          Address Book
        </a>
      </li>
        <li>
        <a href="../wallet/wallet-page.php">
      ...
      <li>
        <a href="../my-request/myrequest.php" >
          <img src="../assets/images/icons/home-assets/myrequests-purple.png" class="white-img" alt="Wallet">
          <img src="../assets/images/icons/home-assets/myrequests.png" class="black-icon" alt="Wallet">
          My Requests
        </a>
      </li>
      <li>
        <a href="../complaints/complaints-list.php" >
      ...
      <li>
        <a href="../my-document/my-document.php" >
          <img src="../assets/images/icons/home-assets/mydocuments-purple.png" class="white-img" alt="Wallet">
          <img src="../assets/images/icons/home-assets/mydocuments.png" class="black-icon" alt="Wallet">
          My Documents
        </a>
      </li>
      <li>
        <a href="../market-place/market-place.php" >
          <img src="../assets/images/icons/home-assets/marketplace-purple.png" class="white-img" alt="Wallet">
          <img src="../assets/images/icons/home-assets/marketplace.png" class="black-icon" alt="Wallet">
          Marketplace
        </a>
      </li>
      <li>
        <a href="../code-verifier-tool/code-verifier-tool.php" >
          <img src="../assets/images/icons/home-assets/code-verification-tool-purple.png" class="white-img" alt="Wallet">
          <img src="../assets/images/icons/home-assets/code-verification-tool.png" class="black-icon" alt="Wallet">
             ...
             <form class="form-inline my-2 my-lg-0">
               ...
               <ul class="navbar-nav ml-auto">
                    <li class="nav-item switch-option">
                       <div class="inner-div">
                         <span class="text">Switch to Verifier view </span>
                          <label class="switch">
                            <input type="checkbox">
                    ...
                    <li class="nav-item dropdown notification-icon">
                       ...
                       <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                          <li class="dropdown-menu-header">
                            ...
                            <li class="scrollable-container media-list w-100 ps-container ps-theme-dark">
                             ...
                             <li class="dropdown-menu-footer"><a class="dropdown-item read-mor-link text-muted text-center" href="../notification/all-notification.php">Read all notifications</a></li>
                        </ul>
                    </li>
                     <li class="nav-item dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="../profile-pages/profile.php"><img src="../assets/images/icons/9.png"> Profile</a>
                            <a class="dropdown-item" href="../profile-pages/change-password.php"><img src="../assets/images/icons/10.png"> Change Password</a>
                            <a class="dropdown-item" href="../profile-pages/change-pin.php"><img src="../assets/images/icons/10.png"> Change Pin</a>
