...
app.use(session({
	secret : SESSION_SECRET,              // 'dsfdsf565456sdf87s5c4xvdsf5644',
	resave : false,
...
// 	db.sync();
//   }).listen(5050);
app.listen(5053,function(){

	// profile_func.userDetail(1).then((res) => {
 //        return res;
 //    }).then((res) =>{
 ...
 //    });
	...
	//console.log("user profile",user_pic);

    // user_pic.then(function(reslt){
...
// var newval = await db.query('select * from tbl_security_questions');
// console.log(newval);


	// user.create({full_name:'Barkha',email:'barkha@questglt.com',mobile_number:'1234567890',birthplace:'India',dob:'12/09/1997',password:'123456'}).then(function(err,result){
	...
	// SecurityMasterModel.create({question:'What is your favorite cartoon?'}).then(function(err,result){
